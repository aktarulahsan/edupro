...
import 'package:edupro/presentation/subjective/subjective_question_screen.dart';
...
class SubjectiveSetVew extends StatefulWidget {
  ...
  @override
  State<SubjectiveSetVew> createState() => _SubjectiveSetVewState();
}
...
class _SubjectiveSetVewState extends State<SubjectiveSetVew> {
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final examSet = controller.questionSets[index];
                ...
                Row(
                  children: [
                    ...
                    _buildInfoChip(
                      ...
                      label: 'Questions ${examSet.questions.length}',
                    ),
                  ],
                ),
              ],
  ...
  void _showStartDialog(BuildContext context, QuestionSet examSet, int index) {
    showDialog(
      context: context,
